...
class BaseAction extends Action{
	...
	protected function _initialize()
	{
		...
		$public = array('css'=>'/AUI/Public/css','js'=>'/AUI/Public/js','img'=>'/AUI/Public/images/','root'=>'/AUI/Public');
		...
		//wechat 
	    $appid = 'wx1c21986a61a57628'; //AppID(应用ID)
	    $token = 'miogsv1407837011'; //微信后台填写的TOKEN
	    $secret = '1fddee484d52f2b0a528935ab74189d6 '; //AppSecret(应用密钥)
